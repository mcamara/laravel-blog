...
@section('content')
	...
	{{ Form::open(['url' => route('storePost'), 'files' => true ,'class'=>'form-horizontal']) }}
		<div id="languageInfo" class="col-md-12">
			...
			<div id='content' class="tab-content">
					...
					@endif
						<div class="form-group">
						  	...
						  	<div class="col-md-6 col-sm-9 col-xs-12">
								{{ Form::text("title_".$abbrlang,"",['class'=>"form-control","placeholder"=>Lang::get('messages.post_title')]) }}
						  	</div>
						</div>
						<div class="form-group">
						  	<label for="content_{{$lang}}" class="col-md-2 col-sm-3 col-xs-6 control-label">@lang('messages.post_content')</label>
						  	<div class="col-md-9 col-sm-9 col-xs-12">
								{{ Form::textarea("content_".$abbrlang,"",['class'=>"form-control ckeditable"]) }}
						  	</div>
						</div>
					</div>
				@endforeach
				<div class="form-group">
				  	...
				  	<div class="col-md-6 col-sm-9 col-xs-12">
						{{ Form::text("categories","",['id' => "id_typeahead",'class'=>"typeahead","placeholder"=>Lang::get('messages.categories')]) }}
				  	</div>
				</div>
				<div class="form-group">
		...
		{{ Form::submit(Lang::get('messages.post_create'),["class"=>"btn btn-lg btn-primary"]) }}
		{{ Form::token() }}
	{{ Form::close() }}
@stop
